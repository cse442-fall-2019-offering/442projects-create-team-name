...
public class QueryTool {
    ...
    public final static String API_URL = "https://www-student.cse.buffalo.edu/CSE442-542/2019-Fall/cse-442v/api/";
    ...
    public static String getFullUrl(String location, String param_var, String[] query_params){
        Uri.Builder builder = Uri.parse(location).buildUpon();
